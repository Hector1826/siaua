...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 09-10-2022 a las 00:25:44
...
CREATE TABLE `manzana` (
  ...
  `manzana_numero` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish2_ci;
...
INSERT INTO `manzana` (`id_manzana`, `manzana_nombre`, `manzana_numero`) VALUES
(1, 'Los Fresnos', 1),
(2, 'La Playa', 2),
(3, 'La Palma', 3),
(4, 'La Frontera', 4),
...
--
DELIMITER $$
CREATE TRIGGER `trigger_insert_servicio` AFTER INSERT ON `persona` FOR EACH ROW INSERT INTO servicio (
    	id_servicio, 
    	servicio_folio, 
    	servicio_info, 
    	servicio_fecha_alta, 
    	...
    	id_persona) 
     VALUES (
     	0, '202201', 'Toma de agua pootable', NOW(), 1, 0, NEW.id_persona)
$$
DELIMITER ;
...
INSERT INTO `servicio` (`id_servicio`, `servicio_folio`, `servicio_info`, `servicio_fecha_alta`, `servicio_status`, `servicio_direc_actual`, `id_persona`) VALUES
...
(11, '1111', 'Principal', '2022-10-04', 1, 0, 1),
(12, '202201', 'Toma de agua pootable', '2022-10-06', 1, 0, 11),
(13, '202201', 'Toma de agua pootable', '2022-10-06', 1, 0, 12);
...
--
ALTER TABLE `persona_acceso`
  MODIFY `id_persona_acceso` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `servicio_direccion`
  MODIFY `id_servicio_direccion` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
